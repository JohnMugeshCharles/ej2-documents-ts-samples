...
(window as any).default = (): void => {
    // Initialize localization / culture resources used by samples
    loadCultureFiles();
    ...
    if (submitEl) {
        submitEl.addEventListener('click', (e) => { e.preventDefault(); createAndSavePdf(); });
    }
    ...
    if (flatBtnEl) {
        ...
        flatBtnEl.addEventListener('click', (e) => { e.preventDefault(); void flattenUploadedPdf(); });
    }
    ...
    function createAndSavePdf(): void {
        ...
        try {
            ...
            const freeText: PdfFreeTextAnnotation = new PdfFreeTextAnnotation({ x: 405, y: 645, width: 80, height: 30 }, 
                {
                textMarkUpColor: { r: 0, g: 128, b: 0 }, 
                font: new PdfStandardFont(PdfFontFamily.helvetica, 7), 
                text: 'Free Text with Callouts', 
                borderColor: { r: 0, g: 0, b: 255 },
                border: new PdfAnnotationBorder({ width: 0.5 }), 
                calloutLines: [{ x: 365, y: 700 }, { x: 379, y: 655 }, { x: 405, y: 655 }]
            });
            ...
            let circleClodyAnnotation: PdfCircleAnnotation = new PdfCircleAnnotation({ x: 50, y: 620, width: 120, height: 120 }, {
                text: 'Diameter',
                author: 'Syncfusion',
                color: { r: 255, g: 0, b: 0 },
            ...
            circleClodyAnnotation.borderEffect.style = PdfBorderEffectStyle.cloudy;
            circleClodyAnnotation.borderEffect.intensity = 1;
            secondPage.graphics.drawString('Circle Cloud Annotation', font, { x: 50, y: 580, width: 200, height: 30 }, brush as any);
            secondPage.annotations.add(circleClodyAnnotation);
            ...
            // Create new free text annotation with callout
