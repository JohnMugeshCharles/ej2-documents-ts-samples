...
L10n.load({
    'ar-AE': {
        'PdfViewer' : {
            ...
            'Eraser Thickness': 'سمك الممحاة',
            'Eraser': 'ممحاة',
            'Comment filter': 'مرشح التعليقات',
            'Author': 'مؤلف',
            'Annotation type': 'نوع التعليق التوضيحي',
            'Status': 'الحالة',
            'Color': 'لون',
            'Date': 'تاريخ',
            'Include Replies': 'تضمين الردود',
            'Filter settings': 'إعدادات الفلتر',
            'Filter document and comments panel': 'تصفية لوحة المستندات والتعليقات',
            'Select author': 'اختر المؤلف',
            'Select annotation type': 'اختر نوع التعليق التوضيحي',
            'Select color': 'اختر اللون',
            'Select a date': 'اختر تاريخًا',
            'Select status': 'اختر الحالة',
            'Create new text stamp': 'إنشاء ختم نصي جديد',
            'Stamp text': 'نص الختم',
            'Background color': 'لون الخلفية',
            'Text color': 'لون النص',
            'Stamp properties': 'خصائص الختم',
            'Username': 'اسم المستخدم',
            'Time': 'الوقت',
            'Date/Time format': 'تنسيق التاريخ/الوقت',
            'Font style': 'نمط الخط',
            'Image Stamp': 'ختم صورة',
            'Text Stamp': 'ختم نصي',
            'Add New Image Stamp': 'إضافة ختم صورة جديد',
            'Create New Text Stamp': 'إنشاء ختم نصي جديد',
            'Stroke Color': 'لون الإطار',
            'Stroke Thickness': 'سُمك الخط',
            'Insert': 'أدخل',
            'Insert Link': 'أدخل الرابط',
            'Enter URL': 'أدخل الرابط',
            'URL': 'رابط',
            'Position': 'موضع',
            'Enter the page number': 'أدخل رقم الصفحة',
            'Add Links': 'أضف روابط',
            'Apply Organize Actions': 'تطبيق تنظيم الإجراءات',
            'The document was modified and is now in read-only mode. Reload the page to fix this.': 'تم تعديل المستند وأصبح الآن للقراءة فقط. أعد تحميل الصفحة لإصلاح ذلك.',
            'Reload Document': 'إعادة تحميل المستند'
        }
    }
});
/**
